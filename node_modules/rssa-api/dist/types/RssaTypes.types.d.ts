...
export declare const emptyParticipantType: ParticipantType;
export declare const emptyParticipant: Participant;
export declare function isEmptyParticipant(participant: Participant): boolean;
export declare const emptyStep: StudyStep;
export declare function isEmptyStep(step: StudyStep): boolean;
